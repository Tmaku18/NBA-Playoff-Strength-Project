...
Use the same robust settings as [phased_sweep_execution_plan_d0f3e0a3.plan.md](.cursor/plans/archive/phased_sweep_execution_plan_d0f3e0a3.plan.md):
...
```powershell
git add .cursor/plans/archive/outputs4_phase_i_sweeps_2638c514.plan.md config/outputs4_phase1.yaml scripts/sweep_hparams.py outputs4/.gitkeep README.md
git status
