...
## 4. Create .cursor/plans/archive/Update8.md
...
| .cursor/plans/archive/Update8.md                 | New file: changes since Update7 + forward plan (sweeps, primary contributors, playoff learning, actual playoff contribution, NBA metrics). |
