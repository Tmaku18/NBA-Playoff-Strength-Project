...
- **Phase 2 (then):** (4) Harden Model A attention (set_attention, predict fallback, training diagnostics) per [.cursor/plans/archive/fix_attention_+_trustworthy_run_d52cdb1c.plan.md](.cursor/plans/archive/fix_attention_+_trustworthy_run_d52cdb1c.plan.md).
...
After Phase 1, implement the attention and trust fixes from [.cursor/plans/archive/fix_attention_+_trustworthy_run_d52cdb1c.plan.md](.cursor/plans/archive/fix_attention_+_trustworthy_run_d52cdb1c.plan.md):
