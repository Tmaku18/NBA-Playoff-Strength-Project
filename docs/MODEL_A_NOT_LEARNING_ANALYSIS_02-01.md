...
Per **docs/CHECKPOINT_PROJECT_REPORT_02-01.md** (Section 7, run_020) and the fix_attention plan:
...
- **docs/CHECKPOINT_PROJECT_REPORT_02-01.md** — Section 7 (Issues: attention all-zero / Model A not contributing), Section 5 (run_020 vs run_021).
