...
- **Plans:** `.cursor/plans/archive/model_a_attention_fix_and_phased_roadmap_1e5c219f.plan.md`, `archive/refined_sweep_rerun_bc8afb8f.plan.md`, `archive/outputs2_run_019_sweeps_update8_d5fca612.plan.md`, `archive/sweep_rerun_+_attention_check_7aa587c2.plan.md`, `.cursor/plans/Attention_Report.md`, `.cursor/plans/Performance_trajectory_and_hyperparameters.md`.
