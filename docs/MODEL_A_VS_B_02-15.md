...
Comparison of Model A (DeepSet + ListMLE) and Model B (XGB): how they process input, train, produce predictions, why they differ, strengths/weaknesses, and performance across configs. See [BEST_METRICS_02-15.md](BEST_METRICS_02-15.md) for detailed run tables and config notes.
...
Summary from BEST_METRICS_02-15.md and outputs6:
...
For run-by-run tables and config side-by-sides, see [BEST_METRICS_02-15.md](BEST_METRICS_02-15.md).
