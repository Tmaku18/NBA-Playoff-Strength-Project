...
- **Report assets:** **outputs/ANALYSIS.md** (current results run_026, split, ListMLE outcome vs standings); **outputs2/** run_020/021/022; **outputs3/** baseline and Phase I sweeps; **outputs4/** production (run_025, run_026); **outputs5/** outcome vs standings; **outputs6_baseline/** baseline; **outputs7_listmle_sweep/** ListMLE sweep; **outputs8_spearman_surrogate/** best (Spearman surrogate); **outputs9_listmle_spearman/** ListMLE sweep; **outputs10_spearman_surrogate_standing_rank/** Spearman+standing; **outputs11_listmle_standing_rank/** ListMLE+standing; **outputs12_baseline_standing_rank/** baseline+standing; **outputs13_rmse_surrogate/** RMSE surrogate; **outputs14_map_run/** MAP run. Each of **outputs/** through **outputs14/** has a **`MODEL.md`** describing the model and how it differs from the previous output folder. See `outputs4/sweeps/SWEEP_PHASE1_ANALYSIS.md` and `docs/SWEEP_ANALYSIS.md` for sweep analysis.
