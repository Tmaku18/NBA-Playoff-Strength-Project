...
**Official best (production):** Use **outputs8** configs for best Spearman, playoff_spearman, rank_mae, rank_rmse, and NDCG. See **[docs/OFFICIAL_BEST_CONFIGS_AND_ANALYSIS.md](docs/OFFICIAL_BEST_CONFIGS_AND_ANALYSIS.md)** and **[docs/OUTPUTS8_SWEEP_ANALYSIS_02-17.md](docs/OUTPUTS8_SWEEP_ANALYSIS_02-17.md)**. **outputs6** phase_1 is superseded by outputs8 for official best. A planned **outputs9** sweep will use the same setup as outputs7/8 but **ListMLE** (outputs6-style). **outputs10** runs the same Optuna sweep as outputs8 but with **standing rank as input** (implemented on `main`); see [docs/OUTPUTS10_SWEEP_STANDING_RANK.md](docs/OUTPUTS10_SWEEP_STANDING_RANK.md).
